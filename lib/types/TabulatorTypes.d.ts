declare namespace Tabulator { interface Options
    extends
        OptionsGeneral,
        OptionsMenu,
        OptionsHistory,
...
type ColumnCalcParams = { precision: number } | ((values: any, data: any) => any);
...
interface EventCallBackMethods {
    validationFailed: (cell: Tabulator.CellComponent, value: any, validators: Validator[]) => void;
    ...
    rowMoveCancelled: (row: Tabulator.RowComponent) => void;
    rowUpdated: (row: Tabulator.RowComponent) => void;
    rowSelectionChanged: (
        data: any[],
        rows: Tabulator.RowComponent[],
        selectedRows: Tabulator.RowComponent[],
        deselectedRows: Tabulator.RowComponent[],
    ) => void;
    ...
    renderStarted: () => void;
    renderComplete: () => void;
    columnMoved: (column: Tabulator.ColumnComponent, columns: ColumnComponent[]) => void;
    ...
    TooltipClosed: (cell: Tabulator.CellComponent) => void;
    TooltipOpened: (cell: Tabulator.CellComponent) => void;
}
...
declare class Tabulator {
    ...
    setGroupStartOpen: (
        values:
            | boolean
            | boolean[]
            | ((value: any, count: number, data: any, group: Tabulator.GroupComponent) => boolean)
            | Array<boolean | ((value: any, count: number, data: any, group: Tabulator.GroupComponent) => boolean)>,
    ) => void;
