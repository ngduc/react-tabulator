declare namespace Tabulator {
    ...
    type Editor = true | 'input' | 'textarea' | 'number' | 'range' | 'tickCross' | 'star' | 'select' | 'autocomplete' | ((cell: CellComponent, onRendered: EmptyCallback, success: ValueBooleanCallback, cancel: ValueVoidCallback, editorParams: {}) => HTMLElement | false);
...
declare class Tabulator {
    ...
    getHtml: (rowRangeLookup?: Tabulator.RowRangeLookup, style?: boolean, config?: Tabulator.AddditionalExportOptions) => any;
    ...
    print: (rowRangeLookup?: Tabulator.RowRangeLookup, style?: boolean, config?: Tabulator.AddditionalExportOptions) => any;
