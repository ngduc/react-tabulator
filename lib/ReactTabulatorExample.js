...
var default_1 = /** @class */ (function (_super) {
    ...
    default_1.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            React.createElement(React15Tabulator_1["default"], { ref: function (ref) { return (_this.ref = ref); }, columns: columns, data: data, rowClick: this.rowClick, options: options, "data-custom-attr": "test-custom-attribute", className: "custom-css-class" }),
            ...
            React.createElement(React15Tabulator_1["default"], { columns: columns, data: this.state.data }),
            React.createElement("h3", null, "Editable Table"),
            React.createElement(React15Tabulator_1["default"], { columns: editableColumns, data: data }),
